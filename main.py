...
class Main(MDApp):
    ...
    def register(self,user,email,password,confirm,root):
            print('run')
            email=email.strip()
            user=user.strip()
            ...
            if password==confirm:
                try:
                    ...
                    # root.manager.transition.direction='left'
                    # root.manager.current='MainContent'
                    db.child(str(self.user)).child('User_info').set(
                        {'Email':str(email),
                    ...
                    # db.child('Users').child(self.user).child('Categories').child(
                    #         'google').child('info').set({'icon': 'google'})
                    ...
                    # db.child('Users').child(self.user).child('Categories').child(
                    #         'microsoft').child('info').set({'icon':'microsoft' })
